...
<div className="flex flex-col min-h-screen">
    ...
    <div className="max-w-[1200px] mx-auto px-6 pt-16 pb-20">
        ...
        <p className="mt-6 max-w-3xl mx-auto text-lg md:text-xl text-gray-500">
            We are dedicated to providing powerful and elegant tools to help you track your mood and journal your daily experiences with ease.
        </p>
        </section>

        {/* Our Mission */}
        <section className="mb-20 bg-white rounded-3xl shadow-md p-10 max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-md p-8 flex flex-col items-center text-center">
            ...
            className="h-12 w-12 mb-4 stroke-current text-gray-900"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={2}
            stroke="currentColor"
            ...
            Quickly log your mood with simple emojis and get a visual history of your emotional journey.
            </p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-md p-8 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600">
            Write freely about your thoughts and feelings with our clean and distraction-free journal interface.
            </p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-md p-8 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600">
            Review your past journal entries and mood ratings to better understand your emotional patterns.
            </p>
        </div>
        </section>
