...
import JorjiPhoto from '../../../src/assets/img/jorji.jpg';
import NaufalPhoto from '../../../src/assets/img/naufal.jpg';
import FadilPhoto from '../../../src/assets/img/fadil.jpg';
import FarhanPhoto from '../../../src/assets/img/farhan.jpg';
...
const founders = [
  ...
  {
    name: 'Naufal',
    photo: NaufalPhoto, // Replace with actual custom photo URL or local import
    ...
    <Navbar  userData={userData}/>
      ...
      <main className="flex-1 bg-white text-gray-700">
        <div className="mt-20 max-w-[1200px] mx-auto px-6 pt-16 pb-20">
          {/* Hero Section */}
          <motion.section className="mb-20 text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          ...
          {/* Our Mission */}
          <motion.section className="mb-20 bg-white rounded-3xl shadow-md p-10 max-w-4xl mx-auto" whileHover={{ scale: 1.05, boxShadow: '0px 5px 15px rgba(0, 0, 0, 0.2)' }} transition={{ duration: 0.3 }}>
          ...
          {/* What We Offer */}
          <motion.section className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 mb-20" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
            <motion.div className="bg-white rounded-3xl shadow-md p-8 flex flex-col items-center text-center" whileHover={{ scale: 1.1, y: -10 }} transition={{ duration: 0.3 }}>
          ...
          {/* Founders Section */}
          <motion.section className="mb-20 max-w-6xl mx-auto px-4" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }}>
...
const FounderCard = ({ founder }) => {
  ...
  return (
    <animated.div className="bg-white rounded-3xl shadow-md p-8 flex flex-col items-center text-center" style={springProps} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
